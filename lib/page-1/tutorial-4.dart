...
class Scene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        // tutorial4eJj (7:241)
        padding: EdgeInsets.fromLTRB(19*fem, 34*fem, 19.08*fem, 146.2*fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
            Container(
              // hoyaallowanceXNX (7:242)
              margin: EdgeInsets.fromLTRB(0.08*fem, 0*fem, 0*fem, 46*fem),
              child: Text(
                'hoya allowance',
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(98*fem, 0*fem, 97.92*fem, 43*fem),
              width: double.infinity,
              height: 18*fem,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0.08*fem, 0*fem, 0*fem, 19*fem),
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text: ', hit the allowance button when making a payment normally at our partner stores. ',
                      style: SafeGoogleFont (
                        'Outfit',
                        fontSize: 30*ffem,
                        fontWeight: FontWeight.w400,
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 21.43*fem),
              width: double.infinity,
              height: 55.57*fem,
              decoration: BoxDecoration (
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 46.31*fem,
                        child: Image.asset(
                          'assets/page-1/images/helpcenter-zpw.png',
                          width: 46.31*fem,
                          height: 46.31*fem,
                        ),
                      ),
            ...
            Container(
              // continuebuttonn2s (19:191)
              margin: EdgeInsets.fromLTRB(62*fem, 0*fem, 61.92*fem, 0*fem),
              width: double.infinity,
              height: 42.8*fem,
              decoration: BoxDecoration (
