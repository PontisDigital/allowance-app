...
class DiscountStoreCardWidget extends StatefulWidget {
  ...
  @override
  State<DiscountStoreCardWidget> createState() => _DiscountStoreCardWidgetState();
}

class _DiscountStoreCardWidgetState extends State<DiscountStoreCardWidget> {
  @override
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                  ...
                                  style: SafeGoogleFont(
                                    'Inter',
                                    fontSize: !(widget.isRewardPage ?? false)
                                        ? (widget.discount.percentOff.length <= 6
                                            ? 60 * ffem
                                            : 50 * ffem)
                                        : 45 * ffem,
                                    fontWeight: FontWeight.w600,
                ...
                Visibility(
                  visible: (widget.discount.walletMax != null),
                  child: Center(
                    // keepshoppingtorefillyourallowa (324:472)
                    child: Text(
                      'Maximum wallet amount is ${widget.discount.walletMax ?? ''}',
                      style: SafeGoogleFont(
                        'Inter',
                        fontSize: 12 * ffem,
                ...
                Visibility(
                  visible: (widget.discount.minSpend != null),
                  child: Center(
                    // keepshoppingtorefillyourallowa (324:472)
                    child: Text(
                      'You must make a purchase of at least ${widget.discount.minSpend ?? ''}',
                      style: SafeGoogleFont(
                        'Inter',
                        fontSize: 12 * ffem,
                        fontWeight: FontWeight.w700,
        ...
        Visibility(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(widget.discount.merchantName,
                  style: SafeGoogleFont(
                    'Outfit',
                    fontSize: 18,
                    fontWeight: FontWeight.w700,
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CommunityPage(
            merchantName: widget.discount.merchantName,
